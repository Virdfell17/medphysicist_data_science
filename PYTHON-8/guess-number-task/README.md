...
- Функция должна принимать всего одно значение - искомое число и возвращать количество попыток его поиска.
...
- Бинарный поиск сокращает это количество в среднем до 5 попыток.
...
- `game_binary_search_2.py`: Более общий вариант решения, который эффективен при поиске элемента в отсортированном массиве
